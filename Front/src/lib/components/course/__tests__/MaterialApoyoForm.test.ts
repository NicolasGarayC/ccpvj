...
describe('MaterialApoyoForm', () => {
	...
	describe('Create Mode', () => {
		...
		it('should call createMaterialApoyoWithId when form is submitted', async () => {
			...
			const { component } = render(MaterialApoyoForm, { course: null, loading: false });
	...
	describe('Edit Mode', () => {
		...
		it('should call updateMaterialApoyo when form is submitted in edit mode', async () => {
			...
			const { component } = render(MaterialApoyoForm, {
	...
	describe('Error Handling', () => {
		it('should emit error event when creation fails', async () => {
			const { materialApoyoService } = await import('$lib/services/materialApoyoService');
		...
		it('should emit error event when update fails', async () => {
			const { materialApoyoService } = await import('$lib/services/materialApoyoService');
