...
import type { PostDetail } from '$lib/application/services/material-apoyo/ModulePostService';
	...
	export let onView: ((post: PostDetail) => void) | undefined = undefined;
	export let onEdit: ((post: PostDetail) => void) | undefined = undefined;
	export let onDelete: ((postId: string) => void) | undefined = undefined;
