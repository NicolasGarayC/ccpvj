...
export let onCreateModule: ((payload: { courseId: string }) => void) | undefined = undefined;
export let onEditModule: ((moduleId: string) => void) | undefined = undefined;
export let onDeleteModule: ((moduleId: string) => void) | undefined = undefined;
export let onViewModule: ((moduleId: string) => void) | undefined = undefined;
export let onModuleReordered:
	((payload: { moduleId: string; newOrder: number }) => void) | undefined = undefined;
...
const dispatch = createEventDispatcher<{
	...
	deleteModule: string;
	viewModule: string;
	moduleReordered: { moduleId: string; newOrder: number };
}>();
