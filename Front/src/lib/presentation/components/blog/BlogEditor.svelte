<script lang="ts">
  ...
  export let mediaUploaderComponent: typeof MediaUploader = MediaUploader;
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      let result: BlogPost;
      if (post) {
        result = await blogService.updatePost(String(post.id), basePost);
      } else {
        const createPayload = {
          ...basePost,
        ...
        result = await blogService.createPost(createPayload);
      }
