...
```svelte
<script>
import BlogEventRelation from '$lib/presentation/components/blog/BlogEventRelation.svelte';
...
import BlogEventRelation from '$lib/presentation/components/blog/BlogEventRelation.svelte';
import { blogEventRelationService } from '$lib/application/services/blog/BlogEventRelationService';
