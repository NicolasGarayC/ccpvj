...
import FeatureCardSlotWrapper from './FeatureCardSlotWrapper.svelte';
...
describe('FeatureCard Component', () => {
	...
	describe('Slot Content', () => {
		it('should render slot content', () => {
			render(FeatureCardSlotWrapper, { props: { title: 'Title', description: 'Description' } });
	...
	describe('Props Updates', () => {
		...
		it('should update description when prop changes', async () => {
			...
			await rerender({ description: 'Updated Description' });
		...
		it('should update icon when prop changes', async () => {
			const { container, rerender } = render(FeatureCard, {
				props: { icon: 'fas fa-check' }
			});

			expect(container.querySelector('i.fas.fa-check')).toBeInTheDocument();

			await rerender({ icon: 'fas fa-star' });
		...
		it('should show icon when changed from empty to non-empty', async () => {
			...
			await rerender({ icon: 'fas fa-check' });
