...
class MaterialApoyoService extends BaseHttpService {
	...
	async getMaterialApoyo(params?: MaterialApoyoSearchParams): Promise<MaterialApoyoPagedResultDto> {
		...
		return this.get<MaterialApoyoPagedResultDto>(`/materialapoyo?${urlParams.toString()}`);
	}
