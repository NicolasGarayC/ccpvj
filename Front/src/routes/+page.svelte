...
>
	...
	<div class="pointer-events-none absolute bottom-0 left-0 w-full overflow-hidden leading-none">
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none" class="h-12 w-full">
			<path d="M321.39,56.44c58-10.79,114.16-30.13,172-41.86,82.39-16.72,168.19-17.73,250.45-.39C823.78,31,906.67,72,985.66,92.83c70.05,18.48,146.53,26.09,214.34,3V120H0V95.71C59.71,118.14,130.83,141.06,213.2,56.44Z" class="fill-white"></path>
		</svg>
	</div>
</section>
...
<section class="bg-gray-50 py-16">
	<div class="container mx-auto px-4">
		...
		<div class="mt-12 text-center">
			<a href="/blog" class="inline-flex items-center rounded-lg bg-indigo-600 px-8 py-3 font-medium text-white shadow-md transition-colors hover:bg-indigo-700 hover:shadow-lg">
				{t('viewAllNews')}
			...
			{#each educationalModules as module}
				...
				>
					<div class="mt-4 flex items-center justify-between">
						<a href={`/courses/${module.id}`} class="group inline-flex items-center font-medium text-indigo-600 transition-colors hover:text-indigo-800">
							{t('accessMaterials')}
...
<section class="bg-gradient-to-b from-gray-50 to-white py-16">
	<div class="container mx-auto px-4">
		...
		<div class="grid gap-8 md:grid-cols-3">
			{#if featuredCourses.length > 0}
				{#each featuredCourses as course}
					<div class="overflow-hidden rounded-xl border border-gray-100 bg-white shadow-lg transition-all hover:-translate-y-2 hover:shadow-xl">
						<div class="flex h-36 items-center justify-center bg-gradient-to-r from-indigo-500 to-purple-600">
						...
						<div class="p-6">
							...
							<div class="flex items-center justify-between">
								<a href={`/courses/${course.id}`} class="group inline-flex items-center font-medium text-indigo-600 transition-colors hover:text-indigo-800">
		...
		<div class="mt-12 text-center">
			<a href="/courses" class="inline-flex items-center rounded-lg border-2 border-indigo-600 bg-white px-8 py-3 font-medium text-indigo-600 shadow-md transition-colors hover:bg-indigo-50 hover:shadow-lg">
				{t('viewAllCourses')}
				<i class="fas fa-arrow-right ml-2"></i>
			</a>
		</div>
...
<section class="bg-gradient-to-br from-indigo-900 to-purple-800 py-16 text-white">
	<div class="container mx-auto px-4 text-center">
		...
		<div class="flex flex-wrap justify-center gap-4">
			<a href="/courses" class="flex transform items-center gap-2 rounded-lg bg-white px-8 py-3 font-medium text-indigo-700 shadow-lg transition-all hover:scale-105 hover:bg-gray-100">
				<i class="fas fa-book-open"></i>
				{t('exploreCourses')}
			</a>
			<a href="/blog" class="flex items-center gap-2 rounded-lg border-2 border-white bg-transparent px-8 py-3 font-medium text-white transition-all hover:bg-white/20">
